/*************************************************************************
	> File Name: 8.Generalized_List.c
	> Author: 
	> Mail: 
	> Created Time: 2020年02月15日 星期六 20时31分26秒
 ************************************************************************/
#include <stdlib.h>
#include<stdio.h>
#include <string.h>
...
void pre_orderNodew(Node *node) {
    if(node == NULL) return;
    printf("%c ", node->data);
    pre_orderNodew(node->lchild);
    pre_orderNodew(node->rchild);
    return ;
}
